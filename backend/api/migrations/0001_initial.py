...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lastVisit', models.DateField(default=datetime.date(2023, 6, 17))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.PositiveIntegerField(default=0)),
                ('time', models.DateTimeField(default=datetime.datetime(2023, 6, 17, 9, 58, 44, 734923, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joinDate', models.DateField(default=datetime.datetime(2023, 6, 17, 9, 58, 44, 736928, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='option', to='api.customatizationoptions')),
            ],
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', models.ManyToManyField(blank=True, related_name='customization_options', to='api.customatizationoptions')),
            ],
        ),
        migrations.AddField(
            model_name='menuitem',
        ...
        migrations.AddField(
            ...
            name='customizations',
            field=models.ManyToManyField(blank=True, related_name='customizations', through='api.Quantity', to='api.customatizationoptions'),
        ),
        migrations.AddField(
            model_name='itemdetail',
            name='item',
